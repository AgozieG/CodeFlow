...
const features = [
    {
        ...
        description:"Intelligent code suggestions powered by advanced AI that learns from patterns. Get real-time assistance with syntax, logic, and best practices.",
        codeSnippet: `
function Footer() {
    return(
        <div></div>
...
export default Footer;`,
    ...
    },
    {
        ...
        description:"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem sunt, unde et earum neque in incidunt accusantium! Consectetur ullam vero quas minima mollitia! Neque quam facilis ab aliquid, nostrum dolorum.",
        codeSnippet: `
function Footer() {
    return(
        <div></div>
            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                        ...
                        <br />
                        <span className="bg-gradient-to-b from-blue to-cyan-400 bg-clip-text text-transparent">Workflow</span>
                    </h2>
                </div>
                        ...
                        <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition === "right" && "lg:flex-row-reverse"}`}>
                            ...
                            <div className="flex-1 w-full">
                                <div className="relative group">
                                    ...
                                    <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border-1 group-hover:border-blue-600/50 transition-all duration-400">
                                        {/* Ide interface */}
                                        <div className="bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-sm">
                                            ...
                                            <div>
                                                ...
                                                language="javascript" 
                                                style={nightOwl}
                                                costumStyle={{margin:0, borderRadius:"8px", background:"transparent", fontSize:"0.75rem", lineHeight:"1.4",height:"100%", border:"1px solid #3c3c3c"}}
                                                wrapLines={true}>
                                                    {feature.codeSnippet}
                                                </SyntaxHighlighter>
                                            </div>
