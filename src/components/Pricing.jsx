            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                        ...
                        <br />
                        <span className="bg-gradient-to-b from-blue to-cyan-400 bg-clip-text text-transparent">Pricing Plans</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
                    {plans.map((plan,key) => (
                        ...
                        ${plan.mostPopular ? "border-blue-500 shadow-2xl shadow-blue-500/20 lg:scale-105" : "border-slate-800 hover:border-slate-700"}`}>
                            <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform -translate-x-full -translate-y-full group-hover:translate-y-0 group-hover:translate-x-0 pointer-events-none rounded-lg"/>
                            {plan.mostPopular && (
                            ...
                            <div className="text-center mb-6 sm:mb-8">
                                ...
                                <div className="flex items-baseline justify-center">
                                    <span className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text ">{plan.price}</span>
                            ...
                            <button className={` w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg font-semibold transition-all duration-400 mt-auto hover:scale-102 corsur-pointer text-sm sm:text-base
